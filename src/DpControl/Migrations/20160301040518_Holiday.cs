...
namespace DpControl.Migrations
{
    public partial class Holiday : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "ModifiedDate", schema: "ControlSystem", table: "Holidays");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropColumn(name: "CreateDate", schema: "ControlSystem", table: "Holidays");
            migrationBuilder.AddColumn<DateTime>(
                name: "ModifiedDate",
                schema: "ControlSystem",
                table: "Holidays",
