...
namespace DpControl.Controllers.APIControllers
{
    public class LocationsController:BaseAPIController
    {
        ...
        [EnableQuery]
        [FormatReturnType]
        public async Task<IEnumerable<LocationSearchModel>> GetAllAsync([FromUri] Query query)
        {
        ...
        public async Task<IActionResult> DeleteByProjectIdIdAsync(int locationId)
        {
